...
// Defines values for ProfileEnrichmentRuleTraitType.
const (
	Computed ProfileEnrichmentRuleTraitType = "computed"
	Static   ProfileEnrichmentRuleTraitType = "static"
)
...
type ProfileEnrichmentRule struct {
	...
	TraitType          *ProfileEnrichmentRuleTraitType     `json:"trait_type,omitempty"`
...
// ProfileEnrichmentRuleTraitType defines model for ProfileEnrichmentRule.TraitType.
type ProfileEnrichmentRuleTraitType string
...
type ServerInterface interface {
	// Get events by application ID
	// (GET /app/{application_id}/events)
	GetEventsByAppId(c *gin.Context, applicationId string)
	// Get events by application ID
	// (GET /app/{application_id}/events/{event_id})
	GetIndividualEventByAppId(c *gin.Context, applicationId string, eventId string)
	...
	// Get events for a specific user profile
	// (GET /{profile_id}/events)
	GetUserEvents(c *gin.Context, profileId string)
	// Get a specific event for a user profile
	// (GET /{profile_id}/events/{event_id})
	GetUserEvent(c *gin.Context, profileId string, eventId string)
}
...
// GetEventsByAppId operation middleware
func (siw *ServerInterfaceWrapper) GetEventsByAppId(c *gin.Context) {
	...
	siw.Handler.GetEventsByAppId(c, applicationId)
}

// GetIndividualEventByAppId operation middleware
func (siw *ServerInterfaceWrapper) GetIndividualEventByAppId(c *gin.Context) {
	...
	siw.Handler.GetIndividualEventByAppId(c, applicationId, eventId)
}
...
func (siw *ServerInterfaceWrapper) GetUserEvents(c *gin.Context) {
	...
	siw.Handler.GetUserEvents(c, profileId)
}

// GetUserEvent operation middleware
func (siw *ServerInterfaceWrapper) GetUserEvent(c *gin.Context) {
	...
	siw.Handler.GetUserEvent(c, profileId, eventId)
}
...
func RegisterHandlersWithOptions(router gin.IRouter, si ServerInterface, options GinServerOptions) {
	...
	router.GET(options.BaseURL+"/app/:application_id/events", wrapper.GetEventsByAppId)
	router.GET(options.BaseURL+"/app/:application_id/events/:event_id", wrapper.GetIndividualEventByAppId)
	...
	router.GET(options.BaseURL+"/:profile_id/events", wrapper.GetUserEvents)
	router.GET(options.BaseURL+"/:profile_id/events/:event_id", wrapper.GetUserEvent)
}
